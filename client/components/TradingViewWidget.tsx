...
interface TradingViewWidgetProps {
  ...
  save_image?: boolean;
  container_id?: string;
  style?: 'line' | 'area' | 'bars' | 'candles' | 'heikin_ashi' | 'hollow_candles' | 'baseline' | 'renko' | 'line_break' | 'kagi' | 'point_and_figure';
}
...
const TradingViewWidget = memo(({
  ...
  }, [symbol, theme, interval, range, hide_side_toolbar, allow_symbol_change, save_image, container_id, style]);
