          ...
          <CardContent className="space-y-6">
            <form className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-sm text-forex-cyan hover:text-forex-cyan/80 transition-colors">
                  Forgot Password?
                </Link>
              </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-forex-dark-200 px-4 text-white/70">Or continue with</span>
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              <p className="text-white/70">
                ...
                <Link to="/signup" className="text-forex-cyan hover:text-forex-cyan/80 font-semibold transition-colors">
                  Create Account
                </Link>
              </p>
            </div>
